    ...
    <div class="container">
	    <div class="row">
            <div class="row">
	    	    ...
	    	    <div class="col-1">
                    <div class="nav_text">Эбаут ми</div>
                </div>
            </div>
	    </div>
        <div class="container">
            <div class="row">
                <div class="col-8">
                    <h2>Мымрин Геннадий, начинающий специалиист</h2>
                </div>
                <div class="col-4">
                    <div class="my_photo"></div>
                    <div class="row">
                        <p class="title_photo">Мымрин Г.Г.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-12">
                <form method="POST" action="profile.php">
                    ...
                    <textarea name="text" class="form" cols="30" rows="10" placeholder="Ваш текст"></textarea>
